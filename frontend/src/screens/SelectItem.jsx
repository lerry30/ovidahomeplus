    ...
    const search = async (ev) => {
        try {
            ...
            if(response) {
                ...
                //I decided that the fetch from invertory is just like here
                //and just remove disabled items.
                
                const searched = []; 
                for(const itemsData of data) {
                    if(itemsData?.disabledNote) continue;
                    searched.push(itemsData);
                }
